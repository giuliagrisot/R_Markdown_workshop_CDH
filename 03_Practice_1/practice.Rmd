...
# XXXX <- read_csv("rmarkdown_intro_data/StudentsPerformance.csv")
...
Write your comment beneath if you want!
You can even insert footnotes: just add a square bracket "box", with a "^" symbol inside followd by the a label of your choice (it must be a unique label!). then, anywhere in the Markdown document, repeat the exact same box at the beginning of a new line, add a column after that, and write the content of the footnote.
I know. it's  a lot, much easier dione than said though! here is what it looks like (commented)
